...
class Program
{
    ...
    static List<employeeCr> identityE = new List<employeeCr>();
        static List<shop> getitem = new List<shop>();
      ...
      /*       Stock Dummy data (Hard Code)      */
        ...
        public static void buyershopping()
        {
            buyerlogo();
            Console.ForegroundColor = ConsoleColor.DarkYellow;
            Console.WriteLine("Purschacing thing In the Given menue");
            Console.ForegroundColor = ConsoleColor.DarkBlue;
            ...
            for (int x=0; x<data.Count;x++)
            {
                ...
                Console.WriteLine("Item: " + data[x].itemname + "\t\t\t\t\t\t" + "Item Price: " + data[x].itemprice);
            }
            Console.ForegroundColor = ConsoleColor.DarkMagenta;
            Console.Write("PRESS S TO START SHOPPING : ");
            s:
           char key = char.Parse(Console.ReadLine());
            ...
            {
                Console.WriteLine("Your Choics is Incorrect please press S: ");
                    goto s;
            }
        ...
        public static void shopping()
        {
            ...
            while (!(receiptchoice == 'r' || receiptchoice == 'R'))
            {
               ...
               Quan= int.Parse(Console.ReadLine());
                for (int x = 0; x < data.Count; x++)
                {
                    ...
                    {
                        Console.WriteLine("________PRICE: " + data[x].itemprice);

                        sum = Quan * data[x].itemprice;
                        Console.WriteLine("________Full PRICE: " + sum);
                        shop s = new shop();
                        s.item = name;
                        s.quantity = Quan;
                        s.price = sum;
                ...
                if (flag == 1)
                {
                    ...
                    total = total + sum;
                    Console.WriteLine("__________TO GET RECEIPT PLEASE! PRESS 'R' and any other key to get more items:  ");

                 receiptchoice =char.Parse( Console.ReadLine());

                }
                if (flag == 0)
                {
                    Console.WriteLine("ITEM IS NOT NOT AVALIABLE");   
                    Console.WriteLine("__________TO GET RECEIPT PLEASE! PRESS 'R' and any other key to get more items:  ");
            ...
            Console.ForegroundColor = ConsoleColor.Black;
            Console.WriteLine("----------------------------------RECEIPT LIST-----------------------------------");
            Console.ForegroundColor = ConsoleColor.DarkBlue;
            for (int x = 0; x < getitem.Count; x++)
           {
                Console.ForegroundColor = ConsoleColor.DarkMagenta;
                Console.WriteLine("Item: " + getitem[x].item + "\t\t\t" +"Quantity:  " + getitem[x].quantity+"\t\t\t"+" Price: " + getitem[x].price);
            }
        ...
        public static void buyerlogo()
        {
            Console.Clear();
            Console.ForegroundColor = ConsoleColor.DarkRed;
            Console.WriteLine("\t\t\t\t\t***********************************************************************************");
            Console.WriteLine("\t\t\t\t\t*                          BUYER  (--..--) MENUE                                   *");
            Console.WriteLine("\t\t\t\t\t***********************************************************************************");
            Console.WriteLine("");
            Console.WriteLine("");
        ...
        public static void employeemenue()
        {
            ...
            {
                if (name == identityE[x].Eusername && pass == identityE[x].Epassword)
                {
                    flag++;
                }
            }
        ...
        public static void employeefunctions()
        {
            ...
            Console.WriteLine("2--------------see total products(stock)"); Console.WriteLine("");
            Console.ForegroundColor = ConsoleColor.DarkRed;
            Console.WriteLine("3--------------Exit"); Console.WriteLine("");
            Console.ForegroundColor = ConsoleColor.White;
            ...
            {
                Console.Write("Choice incorrect Choioce the Right one :  ");
                goto b;
            }
        }

        public static void changeEmpLP()
        {
            Console.Clear();
            employeelogo();
            Console.WriteLine(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>EMployee Password & UserName Change");
            Console.BackgroundColor = ConsoleColor.White;
            Console.ForegroundColor = ConsoleColor.DarkRed;
            char key;
            ...
            for (int x = 0; x < identityE.Count; x++)
            {
                if (username == identityE[x].Eusername && password == identityE[x].Epassword)
                {
                    employeeCr e1 = new employeeCr();
                    Console.WriteLine("");
                    Console.Write("Enter your new username: ");
                    e1.Eusername = Console.ReadLine();
                    Console.Write("Enter your new  password: ");
                    e1.Epassword= Console.ReadLine();
                    identityE.RemoveAt(x);
                    identityE.Insert(x, e1);
                    flag++;
                    break;
                }
            }
        ...
        public static void employeelogo()
        {
            Console.Clear();
    Console.ForegroundColor = ConsoleColor.DarkGreen;
            Console.WriteLine("\t\t\t\t\t***********************************************************************************");
            Console.WriteLine("\t\t\t\t\t*                           EMPLOYEE MENUE                                        *");
            Console.WriteLine("\t\t\t\t\t***********************************************************************************");
            Console.WriteLine("");
            Console.WriteLine("");
        }
